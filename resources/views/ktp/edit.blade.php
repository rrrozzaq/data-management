...
@section('content')
    ...
    <form action="{{ isset($ktp) ? route('ktp.update', $ktp->id) : route('ktp.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_ayah" class="form-control" value="{{ isset($ktp) ? $ktp->nama_ayah : '' }}" oninput="validateText(this)">
        </div>

        <!-- Nama Ibu (Hanya Huruf) -->
        <div class="mb-3">
            <label for="nama_ibu" class="form-label">Nama Ibu</label>
            <input type="text" name="nama_ibu" class="form-control" value="{{ isset($ktp) ? $ktp->nama_ibu : '' }}" oninput="validateText(this)">
        </div>
    ...
    <script>
        ...
        // Fungsi untuk memastikan hanya huruf yang bisa dimasukkan
